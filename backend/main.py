...
def init_db():
    ...
    if count == 0:
        initial_tools = [
            ...
            ("T009", "M18 Jigsaw",                    "available", "Warehouse"),
            ("T010", "M18 Random Orbit Sander",       "in demo",   "IT Demo"),
            ("T011", "M12 Hackzall Saw",              "available", "Warehouse"),
            ("T012", "M18 Band Saw",                  "in demo",   "ES Demo"),
            ("T013", "M18 Oscillating Multi-Tool",    "available", "Warehouse"),
            ("T014", "M12 Soldering Iron",            "available", "Warehouse"),
            ("T015", "M18 Hedge Trimmer",             "in demo",   "UK Demo"),
            ("T016", "M18 Leaf Blower",               "available", "Warehouse"),
            ("T017", "M12 Inspection Camera",         "available", "Warehouse"),
            ("T018", "M18 Cordless Planer",           "in demo",   "PL Demo"),
            ("T019", "M18 Drywall Screwdriver",       "available", "Warehouse"),
            ("T020", "M12 Flex Head Screwdriver",     "available", "Warehouse"),
        ]
        cursor.executemany(
